...
<body>
        ...
        <div class="row">
		    ...
		    <div class="col-md-8">
			    <div class="panel panel-default">
				  <div class="panel-heading">武书连排名简介</div>
				  <div class="panel-body">
					武书连主持的《中国大学评价》对全国所有普通本科大学进行了多项指标排名；包括各大学综合实力排名、12个学科门类排名、480个本科专业排名；以及教师学术水平、教师效率、新生质量、毕业生质量等各项指标的排名和等级。供考生和考生家长、社会各界人士从多个角度观察大学、选择大学。
				  </div>
				</div>
			</div>
		    <div class="col-md-2">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table id="wsl" class="table table-hover">
							<thead>
								<tr>
									<th>
									排名
	...
	<script>
		$(document).ready(function(){
			$.getJSON("http://127.0.0.1:8080/pro/pages/rank_queryAllWSLRank",function(data){
