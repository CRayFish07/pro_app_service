...
<body>
        ...
        <div class="row">
		    ...
		    <div class="col-md-8">
			    <div class="panel panel-default">
				  <div class="panel-heading">交大排名简介</div>
				  <div class="panel-body">
				  “世界大学学术排名”（Academic Ranking of World Universities）， 英文简称ARWU, 是中国国家级研究项目，由中国政府授权上海交通大学世界一流大学研究中心研究发布，2003年首次发布，根据研究结果，每年公布两次。该排名的初衷是寻找中国大学和世界名牌大学在科研上的差距；排名前100名的大学有详细位次排名，后100-400名的大学提供区间排名。
				  </div>
				</div>
			</div>
		    <div class="col-md-2">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table id="jd" class="table table-hover">
							<thead>
								<tr>
									<th>
									排名
	...
	<script>
		$(document).ready(function(){
			$.getJSON("http://127.0.0.1:8080/pro/pages/rank_queryAllJDRank",function(data){
